                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                ...
                                <div class="carousel-caption">
                                    Drone Survey
                                    <p>We perform drone survey</p>
                                </div>
                            </div>

                            <div class="item">
                                <img src="img/about-img.jpg" alt="2">
                                <div class="carousel-caption">
                                    <p style="color:darkgreen">Our Product and services</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="img/slider1.jpg" alt="3">
                                <div class="carousel-caption">
                                    <p style="color:black">Civil and architect service</p>
                                </div>
                            </div>
