					...
					<div class="content-wrapper">
						<section class="about-us-wrapper">
							...
							<div class="row margin-bottom-60"> 
								<div class="col-md-6">
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis culpa deserunt dolorum esse eum, explicabo fugiat maxime modi molestias, neque nesciunt nobis pariatur rem saepe sint suscipit temporibus tenetur veniam!</p>

									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aliquid amet cupiditate, debitis dignissimos excepturi fugit impedit iure modi nam nemo nostrum quia quis ratione rerum sint tempore vero voluptates!</p>
								</div><!-- /.col-md-6 -->

								<div class="col-md-6">
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A animi aperiam assumenda, cum doloribus, expedita ipsa maxime neque non numquam pariatur perferendis provident quos sint, sit soluta vel! Delectus, quis!</p>

									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusamus animi cupiditate deserunt facere, hic labore laudantium numquam praesentium, quae quaerat quas qui tempora, veniam voluptatum? Aperiam fugiat odio recusandae.</p>
								</div><!-- /.col-md-6 -->
							</div><!-- /.row -->
							...
							<div class="row">
								<div class="col-md-12">
									<em>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque deleniti dignissimos ea earum id laboriosam modi, nemo nesciunt officiis perspiciatis placeat qui ratione rem repudiandae sint suscipit ullam vero voluptates!</em>
								</div>
							</div>
